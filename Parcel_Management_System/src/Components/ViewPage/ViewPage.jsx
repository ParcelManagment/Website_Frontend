...
const ViewPage = ({ show, onClose, parcelData, onEdit, onDelete }) => {
    if (!show) return null;
    return(
    ...
    <div className="modal-dialog">
      <div className="modal-content">
        <div className="modal-header">
          <h5 className="modal-title">Parcel Details</h5>
        ...
        <div className="modal-body">
          <form>
            ...
            <div>
              ...
              <input type="text" value={parcelData.package.type || ''} readOnly className="form-control" />
            </div>
            <div>
              <label>Condition of Package:</label>
              <input type="text" value={parcelData.package.package_condition || ''} readOnly className="form-control" />
            </div>
            <div>
              <label>Destination:</label>
              <input type="text" value={parcelData.package.destination || ''} readOnly className="form-control" />
            </div>
            <div>
              <label>Price:</label>
              <input type="number" value={parcelData.package.price || ''} readOnly className="form-control" />
            </div>
            ...
            <div>
              ...
              <input type="text" value={parcelData.sender.first_name || ''} readOnly className="form-control" />
            </div>
            <div>
              <label>Last Name:</label>
              <input type="text" value={parcelData.sender.last_name || ''} readOnly className="form-control" />
            </div>
            <div>
              <label>Email:</label>
              <input type="text" value={parcelData.sender.email || ''} readOnly className="form-control" />
            </div>
            <div>
              <label>Phone Number:</label>
              <input type="text" value={parcelData.sender.mobile_number || ''} readOnly className="form-control" />
            </div>
            ...
            <div>
              <label>First Name:</label>
              <input type="text" value={parcelData.receiver.first_name || ''} readOnly className="form-control" />
            </div>
            <div>
              <label>Last Name:</label>
              <input type="text" value={parcelData.receiver.last_name || ''} readOnly className="form-control" />
            </div>
            <div>
              <label>Email:</label>
              <input type="text" value={parcelData.receiver.email || ''} readOnly className="form-control" />
            </div>
            <div>
              <label>Phone Number:</label>
              <input type="text" value={parcelData.receiver.mobile_number || ''} readOnly className="form-control" />
            </div>
          </form>
        </div>
